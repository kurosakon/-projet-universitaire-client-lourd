...
ListGraphics::ListGraphics(List* l,int index, QWidget* parent):liste(l),QWidget(parent),expanded(false)
{
...
ListGraphics::ListGraphics(List* l, QWidget* parent):liste(l),QWidget(parent),expanded(false)
{
    area=new QMdiArea(this);
